...
public class Activator
	...
	public IControllable clone() {
		return new Activator(Tools.copyIfPresent(position), rotation, scale, image, color, movable, rotatable, Tools.copyIfPresent(rPosition), Tools.copyIfPresent(rDistance),
