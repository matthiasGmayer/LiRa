...
public class ColoredGlass
	...
	public IControllable clone() {
		return new ColoredGlass(Tools.copyIfPresent(position), size, rotation, strength, movable, rotatable, image, color, Tools.copyIfPresent(rPosition), Tools.copyIfPresent(rDistance),
				Tools.copyIfPresent(rAngle),Tools.copyIfPresent(rSpectrum));
	}
