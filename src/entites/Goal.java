...
public class Goal implements IControllable, IScalable, IRenderable, IColorGetter, ILoadable, ISolid, IColorable {
	...
	public IControllable clone() {
		return new Goal(Tools.copyIfPresent(position), rotation, scale, Tools.copyIfPresent(rPosition), Tools.copyIfPresent(rDistance),
				Tools.copyIfPresent(rAngle),Tools.copyIfPresent(rSpectrum), movable, rotatable, image, color);		
	}
